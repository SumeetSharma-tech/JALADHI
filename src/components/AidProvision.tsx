...
const AidProvision: React.FC<AidProvisionProps> = ({
  ...
  const [helpRequests] = useState<HelpRequest[]>([
    {
      id: "1",
      name: "Rajesh Kumar",
      ...
      urgency: "high",
      description:
        "Family of 4 trapped in flooded building. Need food and clean water urgently.",
      peopleAffected: 4,
    ...
    },
    {
      ...
      urgency: "high",
      description:
        "Elderly mother needs insulin. Local chemist closed due to flooding.",
      peopleAffected: 1,
    ...
    },
    {
      ...
      urgency: "medium",
      description:
        "House damaged due to heavy rains. Need temporary shelter for family.",
      peopleAffected: 6,
  ...
  const handleHelpNow = (requestId: string) => {
    setHelpedRequests(new Set([...helpedRequests, requestId]));
  };
